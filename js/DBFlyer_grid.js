...
// Add the Grid class
_namespace.grid = function(globs) {
...
/*
  ...
  roundRect(_drag_mask_ctx, 0.5,0.5,_halo_size-1,_halo_size-1, 5);
...
//    OBJ.update_cursor();
  ...
  OBJ.new_join = function(option,hook){
    var _new_join = new _namespace.join(_globs,{cx: hook.cx,cy: hook.cy});
  ...
  OBJ.new_table = function(option,hook){
    ...
    var default_table_name = new_table_prefix+_namespace.table.new_table_id;
    _namespace.table.new_table_id++;
    default_table_name += " ";
    ...
    var _new_table = new _namespace.table(_globs,{cx: hook.cx,cy: hook.cy,name: new_table_name});
