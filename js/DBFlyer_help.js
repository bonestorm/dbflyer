...
// Add the Help class
_namespace.help = function(globs) {
  var _globs = globs; 
...
";
  ...
  OBJ.draw = function (){
    ...
    */
    ...
    roundRect(_globs.context,box.x+0.5,box.y+0.5,box.width,box.height,20);
    _globs.context.fill();
    ...
    roundRect(_globs.context,dismiss.x+0.5,dismiss.y+0.5,dismiss.width,dismiss.height,5);
    _globs.context.stroke();
