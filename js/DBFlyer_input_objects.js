...
_namespace.input_dropdown = function(globs,options){
...
//stuff in here
  ...
  this.draw = function(ctx){
    ...
    ctx.lineWidth = 1;
    roundRect(ctx, drop_rect[0], drop_rect[1], drop_rect[2], drop_rect[3], 3);
    ctx.stroke();
    ctx.globalAlpha = 1.0;
    ctx.fill();
    ...
    if(this.dropped > 0){
      ...
      for(var i in this.footprint){
        ...
        roundRect(ctx,this.footprint[i].x+0.5,this.footprint[i].y+0.5, this.footprint[i].width, this.footprint[i].height, 4);
        ctx.stroke();
        ctx.globalAlpha = 1.0;
        ctx.fill();
      ...
      if(this.scrollbar !== undefined){
        ...
        function draw_scrollbar_part(part){
          ...
          roundRect(ctx,part.x+0.5,part.y+0.5,part.width,part.height, 4);
          ctx.stroke();
          ctx.globalAlpha = 1.0;
          ctx.fill();
...
_namespace.input_title = function(globs,options){
